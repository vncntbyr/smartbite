...
export const VegetarianIcon = (props: SvgProps) => (
  <Svg id="Icons" viewBox="-2 -2 36 36" {...props}>
    <Circle cx={16} cy={16} r={16} fill="transparent" stroke="black" />
    <Circle cx={16} cy={16} r={16.9} fill="transparent" stroke="black" />
    <Line x1={3} y1={26} x2={26} y2={4} stroke="black" />
    <Line x1={3} y1={27} x2={27} y2={4} stroke="black" />
    <Line x1={3} y1={27.5} x2={28} y2={3.5} stroke="black" />
    <G
      fill="none"
      stroke="black"
      strokeWidth={2}
